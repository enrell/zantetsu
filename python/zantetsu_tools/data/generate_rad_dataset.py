...
Usage:
    python tools/data/generate_rad_dataset.py --output data/training/rad_dataset.jsonl
    python tools/data/generate_rad_dataset.py --titles-only --output data/training/anime_titles.json
"""
